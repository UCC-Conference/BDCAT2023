    ...
    return (
        <PageWrapper>
            <Content>
                ...
                <hr />
                <p>
                    <strong>Histats.com</strong><br/> This website is using <Link to="www.histats.com">Histats.com web analytics</Link>, a web analysis service.<br/> Histats service do not use third party cookies to idemntify user so cannot idemntify you out of this site, the
