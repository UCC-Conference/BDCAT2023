...
import Pdf from "../assets/documents/PhDSymposium/cfds-bdcat.pdf";
import Txt from "../assets/documents/PhDSymposium/cfds-bdcat.txt";
  ...
  return (
    <PageWrapper>
      <Content>
        ...
        <p>Welcome to the Doctoral Symposium of the 10th IEEE/ACM International Conference on Big Data Computing, Applications and Technologies (BDCAT). The Doctoral Symposium is a forum for PhD students to present their work and receive feedback and guidance. The aim is to provide a space for PhD students to meet and interact with peers, and to receive constructive feedback about their work from experts in the field of big data.</p>

        <p>
        BDCAT 2023 will be hosted at Taormina (Italy) by the University of Messina. Taormina is the most touristic city in Sicily.
        </p>
        ...
        <p>
        We invite submissions from PhD students at any stage of their doctoral studies. Submission is open to all areas of Big Data Computing and Applications as per the BDCAT main track call for papers. Submissions should follow the following structure:
        </p>
        ...
        <p>
        All manuscripts will be reviewed and judged on correctness, originality, technical strength, rigor in analysis, quality of results, quality of presentation, and interest and relevance to the conference attendees. The accepted papers will be published on the BDCAT websites.
        </p>
